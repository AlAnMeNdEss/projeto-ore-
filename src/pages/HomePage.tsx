...
export default function HomePage({ user, onFazerPedido, onVerComunidade }: HomePageProps) {
  ...
  return (
    ...
    >
      {/* Topo estilizado igual ao exemplo da imagem */}
      <div className="w-full max-w-md mx-auto rounded-t-3xl bg-[#f6eaff] flex flex-col px-4 pt-6 pb-4 mb-2" style={{boxShadow: '0 2px 12px #e9d8fd'}}>
